...
parser.add_argument("--dataset_root", "-dr", help="Dataset root dir", type=str, default="./data")
...
# int args
parser.add_argument("--nepoch", help="Number of training epochs", type=int, default=30)
...
if __name__ == '__main__':
    ...
    # Setup optimizer
    optimizer = optim.Adam(vae_net.parameters(), lr=args.lr,  weight_decay=args.weight_decay)
